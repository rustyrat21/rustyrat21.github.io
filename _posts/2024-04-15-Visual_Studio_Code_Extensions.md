...
date: 2024-4-15 23:00:00 +0500
categories: [VS Code]
tags: [powershell,extension,]
---

VS Code Extensions that I use on a regular basis.  Use these within different Profiles.
...
- [Python - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=ms-python.python)
	...
	- [Python Debugger - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=ms-python.debugpy)
...
- [Todo Highlighter - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=zerefdev.todo-highlighter)
- [Jupyter - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=ms-toolsai.jupyter)
	...
	- [Jupyter Slide Show - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=ms-toolsai.vscode-jupyter-slideshow)
- [CodeTour - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=vsls-contrib.codetour)
- [AWS Toolkit - Amazon Q, CodeWhisperer, and more - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=AmazonWebServices.aws-toolkit-vscode)
...
- [Jest Runner - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=firsttris.vscode-jest-runner)
...
- [Console Ninja - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=WallabyJs.console-ninja)

## Themes and Customization
- [One Dark Pro - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=zhuangtongfa.Material-theme)
- [Material UI - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=nxt3.vscode-material-ui)
...
- [Crumbs - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=lukaschneider.crumbs)
- [Tabnine: AI Autocomplete & Chat for Javascript, Python, Typescript, PHP, Go, Java & more - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=TabNine.tabnine-vscode)
	- [Plans & Pricing | Tabnine](https://www.tabnine.com/pricing)
- [Front Matter CMS - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=eliostruyf.vscode-front-matter)
